...
class BibleController extends Controller {
	...
	{		
		...
		if(Auth::check()){
			$notes = $this->noteRepository->getFeedForUserWhereVerses(Auth::user(),$chapter->verses->lists('id'));
		}else{
			$notes = $this->noteRepository->getFeedForPublicNotesWhereVerses($chapter->verses->lists('id'));
		}
